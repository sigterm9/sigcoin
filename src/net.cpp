...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sigcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sigcointools.com", "dnsseed.sigcointools.com"},
    {"sigcoinpool.org", "dnsseed.sigcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"sigcointools.com", "testnet-seed.sigcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sigcoin is probably already running."), addrBind.ToString().c_str());
        else
